...
# =============================================================================
# Starting balance for ROI calculations and charts
STARTING_BALANCE = 1000

# =============================================================================
# FEATURE TABLE CONFIGURATION
# =============================================================================
# Active tables used in ETL pipeline - only these should be loaded
ACTIVE_FEATURE_TABLES = [
...
NBA_IMPORTANT_DATES = {
    ...
    "2023-2024": {
        ...
        "postseason_start_date": "2024-04-20",
        "postseason_end_date": "2024-06-17",
    },
    "2024-2025": {
        "reg_season_start_date": "2024-10-22",
        "reg_season_end_date": "2025-04-13",
        "postseason_start_date": "2025-04-19",
        "postseason_end_date": "2025-06-22",
    },
    "2025-2026": {  # Estimated
        "reg_season_start_date": "2025-10-21",
        "reg_season_end_date": "2026-04-12",
        "postseason_start_date": "2026-04-18",
        "postseason_end_date": "2026-06-21",
    },
}
...
# =============================================================================
# Cutoff dates for walk-forward model training.
# Each model is trained on data up to (and including) its cutoff date.
# Models are named: nba_{variant}_thru_{YYYYMMDD}
#
# Variants: cls, reg, cls_vegas, reg_vegas

# Yearly cutoffs (end of regular season) - for historical backtesting
MODEL_YEARLY_CUTOFFS = [
    "2008-04-16",  # 2007-08 season end
    "2009-04-15",  # 2008-09
    "2010-04-14",  # 2009-10
    "2011-04-13",  # 2010-11
    "2012-04-26",  # 2011-12 (lockout shortened)
    "2013-04-17",  # 2012-13
    "2014-04-16",  # 2013-14
    "2015-04-15",  # 2014-15
    "2016-04-13",  # 2015-16
    ...
    "2018-04-11",  # 2017-18
    "2019-04-10",  # 2018-19
    "2020-03-11",  # 2019-20 (COVID pause)
    "2021-05-16",  # 2020-21
    "2022-04-10",  # 2021-22
]

# Monthly cutoffs for last 3 seasons (finer granularity for recent data)
...
# All cutoffs combined, sorted newest first (for model selection)
MODEL_CUTOFFS = sorted(set(MODEL_YEARLY_CUTOFFS + MODEL_MONTHLY_CUTOFFS), reverse=True)

# Model variant definitions
MODEL_VARIANTS = ["cls", "reg", "cls_vegas", "reg_vegas"]

# Training configuration
MODEL_TRAINING_START = "2007-10-30"  # First season with good line coverage
MODEL_EXCLUDED_TYPES = ["RF", "XT", "NN_TORCH", "FASTAI"]  # Large/slow models to skip
