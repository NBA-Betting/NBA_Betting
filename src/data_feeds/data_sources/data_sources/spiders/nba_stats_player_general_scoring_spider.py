...
import pytz
import scrapy
from data_sources.item_loaders import NbaStatsPlayerGeneralScoringItemLoader
from data_sources.items import NbaStatsPlayerGeneralScoringItem
...
class NbaStatsPlayerGeneralScoringSpider(BaseSpider):
    name = "nba_stats_player_general_scoring_spider"
    allowed_domains = ["www.nba.com"]
    custom_settings = {
        "ITEM_PIPELINES": {
            "data_sources.pipelines.NbaStatsPlayerGeneralScoringPipeline": 300
        },
    }
    ...
    def parse(self, response):
        ...
        for row in row_set:
            ...
            loader = NbaStatsPlayerGeneralScoringItemLoader(
                item=NbaStatsPlayerGeneralScoringItem()
            )
