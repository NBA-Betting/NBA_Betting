...
import pytz
import scrapy
from data_sources.item_loaders import NbaStatsBoxscoresAdvUsageItemLoader
from data_sources.items import NbaStatsBoxscoresAdvUsageItem
...
class NbaStatsBoxscoresAdvUsageSpider(BaseSpider):
    name = "nba_stats_boxscores_adv_usage_spider"
    allowed_domains = ["www.nba.com"]
    custom_settings = {
        "ITEM_PIPELINES": {
            "data_sources.pipelines.NbaStatsBoxscoresAdvUsagePipeline": 300
        },
    }
    ...
    def parse(self, response):
        ...
        for row in row_set:
            ...
            loader = NbaStatsBoxscoresAdvUsageItemLoader(
                item=NbaStatsBoxscoresAdvUsageItem()
            )
