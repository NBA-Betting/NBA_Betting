...
import pytz
import scrapy
from data_sources.item_loaders import NbaStatsPlayerGeneralDefenseItemLoader
from data_sources.items import NbaStatsPlayerGeneralDefenseItem
...
class NbaStatsPlayerGeneralDefenseSpider(BaseSpider):
    name = "nba_stats_player_general_defense_spider"
    allowed_domains = ["www.nba.com"]
    custom_settings = {
        "ITEM_PIPELINES": {
            "data_sources.pipelines.NbaStatsPlayerGeneralDefensePipeline": 300
        },
    }
    ...
    def parse(self, response):
        ...
        for row in row_set:
            ...
            loader = NbaStatsPlayerGeneralDefenseItemLoader(
                item=NbaStatsPlayerGeneralDefenseItem()
            )
            ...
            loader.add_value("def_ws", row_dict["DEF_WS"])
