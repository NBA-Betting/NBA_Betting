...
class Game_Record:
    ...
    def load_models(self, ml_cls_model_path, dl_cls_model_path,
        ...
        """
        self.ml_cls_model = load_model(ml_cls_model_path)
        self.dl_cls_model = keras.models.load_model(dl_cls_model_path)
        self.ml_reg_model = load_model(ml_reg_model_path)
        self.dl_reg_model = keras.models.load_model(dl_reg_model_path)
    ...
    def create_predictions(self):
        ...
        self.ml_cls_predictions = predict_model(
            self.ml_cls_model, data=self.inbound_data[ml_pred_feature_set])
        self.ml_reg_predictions = predict_model(
    ...
    def model_pred_bet_direction(self):
        ...
        self.game_records['dl_cls_pred_direction'] = self.game_records[
            'dl_cls_prediction'].apply(lambda x: 'Home'
                                       if x == 1.0 else 'Away')
    ...
    def bet_direction(self):
        ...
        self.game_records["rec_bet_direction"] = self.game_records.apply(
            ...
            == x["dl_cls_pred_direction"] else "Warning-Models Differ",
            axis=1,
        )
...
if __name__ == "__main__":
    ...
    dl_cls_model_path = (
        "../../models/Deep_Learning/NBA_Stats_CLS_Baseline_2022_09_06_20_08_19"
    )
    ml_reg_model_path = "../../models/AutoML/Baseline_Lasso_Reg_PyCaret"
    dl_reg_model_path = (
        "../../models/Deep_Learning/NBA_Stats_REG_Baseline_2022_09_06_20_00_26"
    )
