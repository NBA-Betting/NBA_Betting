...
from ..item_loaders import NbaStatsBoxscoresAdvTraditionalItemLoader
from ..items import NbaStatsBoxscoresAdvTraditionalItem
...
class NbaStatsBoxscoresAdvTraditionalSpider(BaseSpider):
    name = "nba_stats_boxscores_adv_traditional_spider"
    ...
    def parse(self, response):
        ...
        for row in row_set:
            ...
            loader = NbaStatsBoxscoresAdvTraditionalItemLoader(
                item=NbaStatsBoxscoresAdvTraditionalItem()
            )
